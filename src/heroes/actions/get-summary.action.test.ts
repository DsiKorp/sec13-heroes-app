...
describe('getSummaryAction', () => {
    test('should fetch summary data and return complete information', async () => {
        ...
        expect(summary.totalHeroes).toBeGreaterThan(0);
        expect(summary.strongestHero).toBeDefined();
        expect(summary.smartestHero).toBeDefined();
        expect(summary.heroCount).toBeGreaterThan(0);
    });
});