...
import { useQueryHeroDesc } from "@/heroes/hooks/useQueryHeroDesc";

// const superheroData2 = {
//     id: "1",
//     name: "Clark Kent",
//     alias: "Superman",
...
export const HeroPage = () => {
    ...
    const { data: superheroData, isError } = useQueryHeroDesc(idSlug);

    if (isError) return <Navigate to="/" />;

    if (!superheroData) return <div>Loading...</div>;
